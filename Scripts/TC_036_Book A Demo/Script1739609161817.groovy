...
CustomKeywords.'ck_07.urlHelper.getCurrentUrl'()
...
WebUI.click(findTestObject('Object Repository/Advanced Demo/Page_New Thank You Page  OrangeHRM/button_Book a Free Demo'))

WebUI.verifyElementText(findTestObject('Object Repository/Advanced Demo/Page_GET enbook-a-free-demo/h1_Emergency Uncaught TypeError SilverStrip_974ee6'), 
