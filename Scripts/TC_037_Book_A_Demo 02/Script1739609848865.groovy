...
CustomKeywords.'ck_08.refresh.refreshPage'()
...
WebUI.verifyElementText(findTestObject('Object Repository/Advanced Demo/Page_New Thank You Page  OrangeHRM/h1_Thank you'), 
    'Thank you.')

WebUI.click(findTestObject('Object Repository/Advanced Demo/Page_New Thank You Page  OrangeHRM/button_Contact Sales'))

WebUI.verifyElementText(findTestObject('Object Repository/Advanced Demo/Page_GET encontact-sales/h1_Emergency Uncaught TypeError SilverStrip_974ee6'), 
    '[Emergency] Uncaught TypeError: SilverStripe\\Forms\\Form::appendMessage(): Argument #1 ($message) must be of type string, null given, called in /var/www/html/live-website/vendor/silverstripe/framework/src/Forms/Form.php on line 497')
