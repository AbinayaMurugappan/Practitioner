...
WebUI.setText(findTestObject('Object Repository/OrangeHRM/Page_OrangeHRM/input'), 'Thomas')
...
TestData data = findTestData('Data Files/Messages')

String Value = data.getValue(1,1)

WebUI.setText(findTestObject('Object Repository/OrangeHRM/Page_OrangeHRM/CommentBox'), Value)
