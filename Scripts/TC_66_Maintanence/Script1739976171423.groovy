...
// Click on the "Maintenance" span element to initiate a process.
WebUI.click(findTestObject('Object Repository/OrangeHRM/Leaves_Timesheets/Page_OrangeHRM/span_Maintenance'))

// Click on the "Cancel" button to cancel the current action.
WebUI.click(findTestObject('Object Repository/OrangeHRM/Leaves_Timesheets/Page_OrangeHRM/button_Cancel'))

// Click on the "Maintenance" span element again to re-initiate the process.
WebUI.click(findTestObject('Object Repository/OrangeHRM/Leaves_Timesheets/Page_OrangeHRM/span_Maintenance'))

// Click on a div element that indicates administrator access.
...
// Click on the "Confirm" button to proceed with the action.
WebUI.click(findTestObject('Object Repository/OrangeHRM/Leaves_Timesheets/Page_OrangeHRM/button_Confirm'))

// Click on the "Cancel" button again to cancel the action.
WebUI.click(findTestObject('Object Repository/OrangeHRM/Leaves_Timesheets/Page_OrangeHRM/button_Cancel'))
