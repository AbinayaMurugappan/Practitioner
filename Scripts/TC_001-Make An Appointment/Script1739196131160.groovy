...
CustomKeywords.'ck_02.waitHelper.waitForElementClickable'(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Login'), 10)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Trail Appointment')
