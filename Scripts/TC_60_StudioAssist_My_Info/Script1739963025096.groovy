 ...
 *
 */
// Click on the My Info icon to access personal information
WebUI.click(findTestObject('Object Repository/OrangeHRM/Time-Buzz/MyInfo_Icon'))
// Click on the Contact Details section to edit contact information
WebUI.click(findTestObject('Object Repository/OrangeHRM/Time-Buzz/MyInfo_ContactDetails'))

// Set the text for the Other Email field to 'Test'
...
// Click on the Emergency section to possibly update emergency contact details
